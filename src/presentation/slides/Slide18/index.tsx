...
export const Slide18 = (props: SlideProps) => (
  <Slide {...props}>
    ...
    <Text bold margin="80px 0 10px" textAlign="left" textSize="28px">
      Solution
    </Text>
    ...
    <Text bold italic margin="20px 0 0" textAlign="left" textSize="24px">
      With a PROXY!
    </Text>
    <Text italic margin="20px 0 0" textAlign="left" textSize="24px">
      So, in front of our dynamic, platform specific implementations, we can try to put a <strong>proxy</strong> as
      well...
    </Text>
  </Slide>
);
