...
export const Slide14 = (props: SlideProps) => (
  <Slide {...props}>
    ...
    <Text textAlign="left" textSize="24px">
      ...
      between web and native only for react-native itself. <strong>We needed a more generalized solution</strong>, though.
    </Text>
    ...
    <Text textAlign="left" textSize="24px">
      ...
      providing native-like performances. It's <strong>too experimental</strong> to be considered production ready, even today.
    </Text>
  </Slide>
)
