...
export const Slide14 = (props: SlideProps) => (
  <Slide {...props}>
    ...
    <Text bold margin="100px 0 0" textAlign="left" textSize="36px">
      react-native-web
    </Text>
    <Text textAlign="left" textSize="24px">
      ...
      between web and native only for react-native itself. <strong>We needed a more generalized solution</strong>,
      though.
    </Text>

    <Text bold margin="50px 0 0" textAlign="left" textSize="36px">
      react-native-dom
    </Text>
    <Text textAlign="left" textSize="24px">
      Presented at ReactEurope 2018, it takes a completely new approach to the issue, "re-implementing" the web for
      providing native-like performances. It's <strong>too experimental</strong> to be considered production ready, even
      today.
    </Text>
  </Slide>
);
