...
export const Slide10 = (props: SlideProps) => (
  <Slide bgImage={architecturalProposalOverview} style={{ backgroundRepeat: "no-repeat", backgroundSize: "contain" }}>
    <BoxShadow style={{ bottom: "50px", left: "25%", position: "absolute" }}>
      <Text italic margin="20px 0" textSize="24px">
        A visual representation of the proposed architecture
      </Text>
    </BoxShadow>
  </Slide>
);
