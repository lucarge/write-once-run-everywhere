  ...
  <Slide>
    ...
    <Fix ordered margin="100px 0">
      ...
      <ListItem margin="0 0 20px" textAlign="left" textSize="24px">
        ...
        available thanks to 1 to pick the right code at runtime.
      </ListItem>

      <ListItem margin="0 0 20px" textAlign="left" textSize="24px">
        We are taking advantage of the walkthrough that the bundler does for packaging our apps to throw away the
